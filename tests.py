...
class TestBooksCollector:
    ...
    def test_add_new_book_more_negativ_sizes(self, name):
        collector = BooksCollector()
    ...
    @pytest.mark.parametrize('name, genre', [['Последнее дело Холмса', 'Детективы'], ['Тринадцать этажей', 'Ужасы'],
                                             ...
                                             ['Горе от ума', 'Комедии']])
    def test_set_book_genre_add_new_books_genre(self, name, genre):
        collector = BooksCollector()
        collector.add_new_book(name)
    ...
    def test_get_books_with_specific_genre_when_genre(self):
        collector = BooksCollector()
    ...
    def test_add_book_in_favorites_when_books_not_in_list(self):
        collector = BooksCollector()
    ...
    def test_get_list_of_favorites_books_list(self):
        collector = BooksCollector()
